...
> **Note:** If you encounter issues installing **RDKit** with `pip`, it is recommended to install it separately using **Conda**:

```bash
conda install -c conda-forge rdkit
```

Alternatively, you can try installing RDKit using `pip`:
...
- 💼 LinkedIn: *[LinkedIn](https://www.linkedin.com/in/jnanaranjan-majhi-b8519626a/)*
- 🌐 GitHub: *[Github](https://github.com/JnanaranjanMajhi)*
